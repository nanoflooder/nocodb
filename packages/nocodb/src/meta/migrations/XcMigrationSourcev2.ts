...
import * as nc_081_row_color_conditions from '~/meta/migrations/v2/nc_081_row_color_conditions';
...
export default class XcMigrationSourcev2 {
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_081_row_color_conditions':
        return nc_081_row_color_conditions;
    }
  }
}
